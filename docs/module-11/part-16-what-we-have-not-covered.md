...
This module built a working monitoring framework for a deployed CatBoost frequency model. Before moving to the summary, it is worth being explicit about what we left out and why.
